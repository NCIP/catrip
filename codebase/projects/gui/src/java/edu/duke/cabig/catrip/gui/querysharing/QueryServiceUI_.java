...
public class QueryServiceUI_ extends JPanel {
    ...
    Collection<QueryFilterRowPanel_> filterCollection = new Vector<QueryFilterRowPanel_>();  //  @jve:decl-index=0:
...
//        }
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    try { 
                        ...
                        for (Iterator iter = filterCollection.iterator(); iter.hasNext();) {
                            QueryFilterRowPanel_ element = (QueryFilterRowPanel_) iter.next();
    ...
    private QueryFilterRowPanel_ getFilterRowPanel(){
...
//        return filterRow;
    ...
    private void addFilterRow(){
        QueryFilterRowPanel_ filterRow = getFilterRowPanel();
...
//		}
    ...
    public static void main(String[] args) {
        QueryServiceUI_ s = new QueryServiceUI_();
        //s.setOpaque(true);
...
//        CharArrayReader car = new CharArrayReader(chars);
    ...
    public void removeFilter(edu.duke.cabig.catrip.gui.querysharing.QueryFilterRowPanel_ panel){
        Collection<QueryFilterRowPanel_> tempfilterCollection = new Vector<QueryFilterRowPanel_>();
