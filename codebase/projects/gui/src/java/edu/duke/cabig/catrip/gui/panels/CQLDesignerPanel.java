...
/**
 * The XML view of the DCQL is shown in this Panel.
 *
...
public class CQLDesignerPanel extends CPanel {
    ...
    /** set the appropriate colors and XML style for the DCQL xml view. */
    private void init(){
    ...
    /** set the unformatted DCQL xml text into the Editor pane. */
