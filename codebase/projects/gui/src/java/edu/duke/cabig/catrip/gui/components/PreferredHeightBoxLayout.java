 ...
 *
 * This is same as Box Layout, the only difference is that the heights of the components in case of Y_AXIS is preferred height
 * instead of height decided by the available vertical space in the container.
 */
public class PreferredHeightBoxLayout implements LayoutManager2, Serializable{
     ...
     */
    public PreferredHeightBoxLayout(Container target, int axis) {
     ...
     *   null if none
     */
    PreferredHeightBoxLayout(Container target, int axis, PrintStream dbg) {
        this(target, axis);
        this.dbg = dbg;
    }
...
//            xTotal.adjustSizes(10*nChildren, xChildren) ;//
//            yTotal.adjustSizes(10*nChildren, yChildren) ;//
//            xTotal.preferred = xTotal.preferred+10*nChildren;
//            xTotal.minimum = xTotal.minimum+10*nChildren;
//            yTotal = SizeRequirements.getAlignedSizeRequirements(yChildren);
//            yTotal.minimum = yTotal.minimum +10*nChildren;
...
//            }
     ...
     */
    public int resolveAxis( int axis, ComponentOrientation o ) {
        int absoluteAxis;
        if( axis == LINE_AXIS ) {
    ...
    public transient SizeRequirements[] xChildren;
    public transient SizeRequirements[] yChildren;
    public transient SizeRequirements xTotal;
    public transient SizeRequirements yTotal;
    
    public transient PrintStream dbg;
