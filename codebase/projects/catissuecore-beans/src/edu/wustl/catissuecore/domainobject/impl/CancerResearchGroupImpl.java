...
public class CancerResearchGroupImpl
    implements Serializable, CancerResearchGroup
{

    public CancerResearchGroupImpl()
    {
    }
    ...
    {
        boolean flag = false;
        if(obj instanceof CancerResearchGroup)
        {
            CancerResearchGroup cancerresearchgroup = (CancerResearchGroup)obj;
            Long long1 = getId();
            if(long1 != null && long1.equals(cancerresearchgroup.getId()))
                flag = true;
        }
        return flag;
    }
