...
public class RecurrenceData extends Recurrence {
	...
	public DistantSite createDistantSite(int siteCodeNumber){
		...
		if (buildDistantSite(siteCodeNumber)){
			...
			distantSite.setId((getId()*100) + siteCodeNumber);
			if (siteCodeNumber == 1)
	...
	public void setSiteCode1(String siteCode) {
		this.siteCode1 = siteCode;
	}
