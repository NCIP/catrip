...
package gov.nih.nci.cagrid.catriptumorregistry.service;

import gov.nih.nci.cagrid.catriptumorregistry.service.globus.resource.BaseResource;
import gov.nih.nci.cagrid.catriptumorregistry.service.ServiceConfiguration;
 ...
 * 
 */
public abstract class CaTRIPTumorRegistryImplBase {
    private ServiceConfiguration configuration;
	
	public CaTRIPTumorRegistryImplBase() throws RemoteException {
	...
	public gov.nih.nci.cagrid.catriptumorregistry.service.globus.resource.BaseResourceHome getResourceHome() throws Exception {
		ResourceHome resource = getResourceHome("home");
		return (gov.nih.nci.cagrid.catriptumorregistry.service.globus.resource.BaseResourceHome)resource;
	}
