package gov.nih.nci.cagrid.catissuecore.service;

import gov.nih.nci.cagrid.catissuecore.service.globus.resource.BaseResource;
import gov.nih.nci.cagrid.catissuecore.service.ServiceConfiguration;
 ...
 * 
 */
public abstract class CaTissueCoreImplBase {
    private ServiceConfiguration configuration;
	
	public CaTissueCoreImplBase() throws RemoteException {
	...
	public gov.nih.nci.cagrid.catissuecore.service.globus.resource.BaseResourceHome getResourceHome() throws Exception {
		ResourceHome resource = getResourceHome("home");
		return (gov.nih.nci.cagrid.catissuecore.service.globus.resource.BaseResourceHome)resource;
	}
