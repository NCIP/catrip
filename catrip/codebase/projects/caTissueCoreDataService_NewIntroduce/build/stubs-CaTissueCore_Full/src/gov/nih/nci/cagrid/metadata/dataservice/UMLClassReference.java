 ...
 * DomainModel. The refid
 * 				attribute must share the value of an UMLClass.id on the exposedClassCollection
 * of this model. This
 * 				exists solely as an optimization for not duplicating the UMLClass
 * (in XML) everywhere it is associated
