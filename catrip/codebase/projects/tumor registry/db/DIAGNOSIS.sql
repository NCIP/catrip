...
CREATE INDEX TUMOR_REGISTRY.HISTO_IND
 ON TUMOR_REGISTRY.DIAGNOSIS(HISTOLOGY);
 
 CREATE INDEX TUMOR_REGISTRY.HISTO_GRADE_IND
 ON TUMOR_REGISTRY.DIAGNOSIS(HISTOLOGIC_GRADE);
 
 CREATE INDEX TUMOR_REGISTRY.PRIMARY_SITE_IND
 ON TUMOR_REGISTRY.DIAGNOSIS(PRIMARY_SITE);
 
 CREATE INDEX TUMOR_REGISTRY.CAUSE_OF_DEATH_IND
 ON TUMOR_REGISTRY.DIAGNOSIS(CAUSE_OF_DEATH);
