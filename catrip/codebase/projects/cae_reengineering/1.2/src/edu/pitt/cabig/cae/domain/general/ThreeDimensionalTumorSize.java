...
public  class ThreeDimensionalTumorSize 
    extends AnnotationSet
	implements java.io.Serializable 
{
	private static final long serialVersionUID = 1234567890L;

	public ThreeDimensionalTumorSize(){
	   ...
	   public void setMVR( java.lang.String MVR){
		...
		public boolean equals(Object obj){
			boolean eq = false;
			if(obj instanceof ThreeDimensionalTumorSize) {
				ThreeDimensionalTumorSize c =(ThreeDimensionalTumorSize)obj; 			 
				Long thisId = getId();		
