package edu.upmc.opi.caBIG.caTIES.database.domain.service;

import edu.upmc.opi.caBIG.caTIES.database.domain.service.globus.resource.BaseResource;
import edu.upmc.opi.caBIG.caTIES.database.domain.service.ServiceConfiguration;
 ...
 * 
 */
public abstract class CaTIESImplBase {
	
	public CaTIESImplBase() throws RemoteException {
	...
	public edu.upmc.opi.caBIG.caTIES.database.domain.service.globus.resource.BaseResourceHome getResourceHome() throws Exception {
		ResourceHome resource = getResourceHome("home");
		return (edu.upmc.opi.caBIG.caTIES.database.domain.service.globus.resource.BaseResourceHome)resource;
	}
