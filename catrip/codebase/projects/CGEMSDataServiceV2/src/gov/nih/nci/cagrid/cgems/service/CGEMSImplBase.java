package gov.nih.nci.cagrid.cgems.service;

import gov.nih.nci.cagrid.cgems.service.globus.resource.BaseResource;
import gov.nih.nci.cagrid.cgems.service.ServiceConfiguration;
 ...
 * 
 */
public abstract class CGEMSImplBase {
    private ServiceConfiguration configuration;
	
	public CGEMSImplBase() throws RemoteException {
	...
	public gov.nih.nci.cagrid.cgems.service.globus.resource.BaseResourceHome getResourceHome() throws Exception {
		ResourceHome resource = getResourceHome("home");
		return (gov.nih.nci.cagrid.cgems.service.globus.resource.BaseResourceHome)resource;
	}
