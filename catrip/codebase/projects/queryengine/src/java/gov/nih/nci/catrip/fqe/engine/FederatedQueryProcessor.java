...
public class FederatedQueryProcessor {
     ...
     * @return
     */
    public CQLQuery processFederatedQueryPlan(FederatedQueryPlanDocument federatedQryPlan) {
    ...
    /*
    private gov.nih.nci.cagrid.cqlquery.Object  initializeCQLObject(String targetName){
        // initiallize CQLObject , all the nested Queries would get resolved and attached to this CQL object . 
        gov.nih.nci.cagrid.cqlquery.Object cqlObject =  gov.nih.nci.cagrid.cqlquery.Object.Factory.newInstance();
    ...
    */
    ...
    private gov.nih.nci.cagrid.cqlquery.Group processDCQLGroup(gov.nih.nci.cagrid.dcql.Group  dcqlGroup) {
        //convert basic group information and attach group to CQL object
         ...
         gov.nih.nci.cagrid.cqlquery.Group g = new gov.nih.nci.cagrid.cqlquery.Group();
