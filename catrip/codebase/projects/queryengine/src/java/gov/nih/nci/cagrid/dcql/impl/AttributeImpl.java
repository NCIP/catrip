 ...
 */
public class AttributeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.nih.nci.cagrid.dcql.Attribute
{
     ...
     */
    public gov.nih.nci.cagrid.dcql.Predicate.Enum getPredicate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (gov.nih.nci.cagrid.dcql.Predicate.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public gov.nih.nci.cagrid.dcql.Predicate xgetPredicate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.nih.nci.cagrid.dcql.Predicate target = null;
            target = (gov.nih.nci.cagrid.dcql.Predicate)get_store().find_attribute_user(PREDICATE$2);
            if (target == null)
            {
                target = (gov.nih.nci.cagrid.dcql.Predicate)get_default_attribute_value(PREDICATE$2);
            }
            return target;
        }
    }
     ...
     */
    public void setPredicate(gov.nih.nci.cagrid.dcql.Predicate.Enum predicate)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetPredicate(gov.nih.nci.cagrid.dcql.Predicate predicate)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.nih.nci.cagrid.dcql.Predicate)get_store().add_attribute_user(PREDICATE$2);
            }
