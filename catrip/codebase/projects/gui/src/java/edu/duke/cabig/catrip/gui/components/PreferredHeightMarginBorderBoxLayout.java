 ...
 * instead of height decided by the available vertical space in the container. Also the borders have a 5 pix margin on each side.
 */
public class PreferredHeightMarginBorderBoxLayout implements LayoutManager2, Serializable{
     ...
     */
    public PreferredHeightMarginBorderBoxLayout(Container target, int axis) {
     ...
     *   null if none
     */
    PreferredHeightMarginBorderBoxLayout(Container target, int axis, PrintStream dbg) {
        this(target, axis);
        this.dbg = dbg;
    }
