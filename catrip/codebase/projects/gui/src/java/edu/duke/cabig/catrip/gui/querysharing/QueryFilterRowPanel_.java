...
public class QueryFilterRowPanel_ extends JPanel {

	private JComboBox cbFilter = null;
	private JButton delFilterButton = null;
	private QueryServiceUI_ containterPanel;
	 ...
	 * 
	 */
	public QueryFilterRowPanel_(int comboBoxSelection) {
		super();
		initialize();
		getCbFilter().setSelectedIndex(comboBoxSelection);
	}
	public QueryFilterRowPanel_() {
		super();
		initialize();
	}

	public QueryFilterRowPanel_(QueryServiceUI_ p) {
		super();
		initialize();
		containterPanel = p;
	}
        
        public QueryFilterRowPanel_(QueryServiceUI_ p, ArrayList listItems) {
		super();
		initialize();
		containterPanel = p;
