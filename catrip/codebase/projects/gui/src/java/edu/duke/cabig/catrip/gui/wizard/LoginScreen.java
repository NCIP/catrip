...
public class LoginScreen extends CJFrame {
    ...
    private void initComponents() {
        ...
        password = new javax.swing.JComboBox();
        identityProvider = new javax.swing.JPasswordField();
        loginBtn = new javax.swing.JButton();
        clearBtn = new javax.swing.JButton();
        exitBtn = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("caGrid Login");
        setAlwaysOnTop(true);
        setName("LoginScreen");
        setResizable(false);
        ...
        identityProviderLbl.setText("Identity Provider");

        userId.setText("User ID");

        password.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Duke Identity Provider", "NCICB Identity Provider" }));

        identityProvider.setText("User Password");
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(identityProvider, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 320, Short.MAX_VALUE)
                    .add(userId, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 320, Short.MAX_VALUE)
                    .add(password, 0, 320, Short.MAX_VALUE))
                .addContainerGap())
        );
