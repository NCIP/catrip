...
public class IconNodeRenderer implements IGraphNodeRenderer {
    ...
    protected static int PORT_SPACE = 16;
...
//                gr.drawString("xxcvcvxcvxvcv", helper.getBounds(node).x + 10, textRect.y + 1 + ascent+ 20);
//                gr.drawString("popopopopopop", helper.getBounds(node).x + 10, textRect.y + 1 + ascent+ 40);
//                gr.drawString("popopopopopop", helper.getBounds(node).x + 10, textRect.y + 1 + ascent+ 60);
//                gr.drawString("popopopopopop", helper.getBounds(node).x + 10, textRect.y + 1 + ascent+ 80);
                //sanjeev
            }
        }
    }
