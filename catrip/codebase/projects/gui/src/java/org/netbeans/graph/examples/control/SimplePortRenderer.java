...
public final class SimplePortRenderer implements IGraphPortRenderer {
    ...
    private static final Image imagePort = Utilities.loadImage ("org/netbeans/graph/examples/control/resources/port.gif"); // NOI18N
    ...
    public void renderPort (IGraphPort port, Graphics2D gr, int layer) {
        ...
        if (layer == LAYER_PORT  &&  visible) {
            ...
            if (dn != null) {
                ...
                gr.fillRect (textRectangle.x, textRectangle.y, textRectangle.width, textRectangle.height);
