...
- copy the file "catrip-config.xml" from conf dir in dir : "C:\Documents and Settings"\<local-user>\.caTRIP 
- update the location of rootDirectory variable pointing to "conf" dir 
