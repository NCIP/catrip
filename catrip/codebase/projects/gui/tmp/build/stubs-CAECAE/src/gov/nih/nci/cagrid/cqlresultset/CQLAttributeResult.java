...
public class CQLAttributeResult  extends gov.nih.nci.cagrid.cqlresultset.CQLResult  implements java.io.Serializable {
    private gov.nih.nci.cagrid.cqlresultset.TBDAttribute attribute;

    public CQLAttributeResult() {
    }

    public CQLAttributeResult(
           gov.nih.nci.cagrid.cqlresultset.TBDAttribute attribute) {
     ...
     * @return attribute
     */
    public gov.nih.nci.cagrid.cqlresultset.TBDAttribute getAttribute() {
        return attribute;
    }
     ...
     * @param attribute
     */
    public void setAttribute(gov.nih.nci.cagrid.cqlresultset.TBDAttribute attribute) {
        this.attribute = attribute;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://CQL.caBIG/1/gov.nih.nci.cagrid.CQLResultSet", "TBDAttribute"));
